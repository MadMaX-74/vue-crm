        ...
        <div>
            ...
            <form @submit.prevent="submitHandler">
                ...
                <div class="input-field">
                    ...
                    <span class="helper-text invalid" v-if="$v.title.$dirty && !$v.title.required">{{ 'Input_Category' | localize }}</span>
                </div>

                <div class="input-field">
                    <input id="limit" type="number" v-model.number="limit" :class="{invalid: ($v.limit.$dirty && !$v.limit.minValue)}">
                    <label for="limit">{{ 'Limit' | localize }}</label>
                    <span class="helper-text invalid" v-if="$v.limit.$dirty && !$v.limit.minValue">Min value {{$v.limit.$params.minValue.min}}</span>
                </div>
